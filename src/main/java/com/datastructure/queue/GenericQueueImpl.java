...
public class GenericQueueImpl<T> {
    ...
    public GenericQueueImpl(int queueSize) {
    ...
    public void dequeue() {
        if (isQueueEmpty()) {
            ...
            front++;
            if (front == capacity - 1) {
                System.out.println("Pop operation done ! removed: " + elements[front - 1]);
                front = 0;
            } else {
                System.out.println("Pop operation done ! removed: " + elements[front - 1]);
            }
    ...
    public static void main(String a[]) {
        GenericQueueImpl<Integer> queue = new GenericQueueImpl(4);
        queue.enqueue(4);
        queue.dequeue();
        queue.enqueue(56);
        queue.enqueue(2);
